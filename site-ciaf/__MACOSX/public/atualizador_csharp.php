    ...
    if (!empty($senha)) {
        if ($senha == "0KzHPUEY") {
            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                // Altere daqui...
               // mysqli_query($link, "ALTER TABLE parametros ADD tabela_preco enum('SIM', 'NÃO') NOT NULL DEFAULT 'NÃO';");
                mysqli_query($link, "ALTER TABLE movimentacao MODIFY tipo_mov enum('VENDA','SAÍDA','ENTRADA','ENTRADA RÁPIDA','VENDA NF-E','VENDA NFC-E','ORDEM PRODUCAO') NOT NULL;");
               
                // ... até aqui!
                // Se necessário, adicione mais queries ;)
                mysqli_close($link);
                
                echo $nome_bd . " finalizado. movimento 4 <br>";
