...
<link href="{{ asset('css/bootree.min.css') }}" rel="stylesheet">
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="border-radius: 10px;border: solid 1px #00000038;display: flex;align-items: center;padding: 10px;">
            <input type="hidden" id="id_arvore" value="{{$arvore->id}}">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="nome_item">Nome da arvore</label>
                    <input type="text" class="form-control" id="nome_arvore" value="{{$arvore->nome}}" placeholder="nome do item">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
    ...
    <script type="text/javascript">
        ...
        function adicionar_node(){
            ...
            if(!nome_menu){
                ...
                $('#select_pai option').each(function(index, value){
                    ...
                    success:function(data){
                        ...
                        if(data){
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Tudo certo!!',
                                text: 'Arvore editada com sucesso!',
                            });
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'ops!!',
                                text: 'Tivemos um problema para editar essa arvore!',
                            });
