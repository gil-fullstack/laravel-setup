      ...
      @foreach ($produtos as $produto)
        <div class="card" style="margin: 5px;">
            ...
            <div class="card-header" id="heading{{$produto->id}}">
                ...
                <a href="{{url('solucoes_detalhes2').'/'.$produto->id}}" style="float: right;display:flex;align-items:center;justify-content:space-around;" class="btn btn-custom "><i class="fas fa-plus"></i> Mais detalhes</a>
